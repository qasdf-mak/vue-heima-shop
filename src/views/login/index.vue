    ...
    <div class="login-bg" :style="bgUrl">
        ...
        <div class="main-box">
            <transition name="fade" v-if="isLogin">
                <login-box :avatarUrl="avatarUrl" :formLogin="formLogin" :rules="rules" @goLogin="goLogin"
                    @goRegister="isLogin = false">
                </login-box>
            </transition>
            <transition name="fade" v-else>
                <register-box :avatarUrl="avatarUrl" :formRegister="formRegister" :rules="rulesRegister"
                    @goRegister="goRegister" @goLoginView="isLogin = true">
                </register-box>
            </transition>
        </div>
    </div>
